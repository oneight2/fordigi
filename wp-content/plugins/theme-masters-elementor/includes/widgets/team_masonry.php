...
class Widget_TMEA_Team_Masonry extends Widget_Base {

	public function get_name() {
		return 'tme-team_masonry';
	}

	public function get_title() {
		return "[TM] " . esc_html__( 'Team Masonry', 'theme-masters-elementor' );
	}
	...
	public function get_style_depends(){
		return [ 'tme-lib-masonry','elementor-icons-fa-solid','tme-lib-animate','tme-lib-lightbox','tme-team_member' ];
	}
    
    public function get_script_depends() {
		return [ 'tme-lib-masonry','tme-lib-lightbox','tme-team_masonry' ];
	}
	...
	protected function render( ) {
        ...
        if ($settings['gallery']) {
        ?>
        <div id="tme-team-masonry-<?php echo esc_attr($this->get_id()); ?>" class="tme-masonry-grid tme-masonry-alt">
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_TMEA_Team_Masonry() );