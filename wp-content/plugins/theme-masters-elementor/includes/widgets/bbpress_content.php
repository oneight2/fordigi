...
class Widget_TMEA_bbpress_content extends Widget_Base {

	public function get_name() {
		return 'tme-bbpress_content';
	}

	public function get_title() {
		return "[TM] " . esc_html__( 'bbPress Content', 'theme-masters-elementor' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'options' => [
					'bbp-forum-index' => esc_html__( 'Forum Index', 'theme-masters-elementor' ),
                    'bbp-single-forum' => esc_html__( 'Single Forum', 'theme-masters-elementor' ),
                    'bbp-topic-index' => esc_html__( 'Topic Index', 'theme-masters-elementor' ),
                    'bbp-single-topic' => esc_html__( 'Single Topic', 'theme-masters-elementor' ),
                    'bbp-single-reply' => esc_html__( 'Single Reply', 'theme-masters-elementor' )
				]
			]
        );
        ...
        $this->add_control(
			'topic_id',
			[
				'label' => esc_html__( 'Topic (Optional)', 'theme-masters-elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
				'options' => TMEA_get_topics(),
        ...
        $this->add_control(
			'reply_id',
			[
				'label' => esc_html__( 'Reply ID', 'theme-masters-elementor' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Table Header & Footer', 'theme-masters-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
        );
		...
		$this->end_controls_section();
		 ...
		 $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Table Subheader', 'theme-masters-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'conditions'   => [
                    'relation' => 'or',
                    'terms' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Table Row', 'theme-masters-elementor' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_TMEA_bbpress_content() );