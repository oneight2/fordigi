;( function( $ ) {
	...
	cf_wp_customize( 
		'crowdfundly_org_card_name_fontsize', 
		function( newval ) {
	...
	cf_wp_customize( 
		'crowdfundly_org_card_description_fontsize', 
		function( newval ) {
	...
	cf_wp_customize( 
		'crowdfundly_org_card_raised_amount_fontsize', 
		function( newval ) {
	...
	cf_wp_customize( 
		'crowdfundly_all_camp_search_btn_fontsize', 
		function( newval ) {
			$('#allCampaignSearch').css('font-size', newval + 'px');
        }
	);
	...
	cf_wp_customize( 
		'crowdfundly_single_camp_org_name_fontsize', 
		function( newval ) {
			$('.campaign__fundraiser-name').css('font-size', newval + 'px');
			$('.campaign__fundraiser-name a').css('font-size', newval + 'px');
        }
	);
	...
	cf_wp_customize( 
		...
		function( newval ) {
			$('.campaign__actions-btn.donation-btn').html(newval);
        }
	);

	cf_wp_customize( 
		'cf_single_campn_donation_btn_text_fontsize', 
		function( newval ) {
			$('.campaign__actions-btn.donation-btn').css('font-size', newval + 'px');
        }
	);
	...
	cf_wp_customize( 
		...
		function( newval ) {
			$('.campaign__actions-btn.donation-btn').css('text-transform', newval);
        }
	);
	...
	cf_wp_customize(
		...
		function( newval ) {
			...
			$('.g-modal__content').css("background-color", newval);
			$('.donate__inner').css("background-color", newval);
			$('.back-modal-inner').css("background-color", newval);
        }
	);
	...
	cf_wp_customize(
		...
		function( newval ) {
			...
			$('.form-group__amount').css("background-color", newval);
        }
	);
	...
	cf_wp_customize(
		...
		function( newval ) {
			...
			$('.form-group__amount').css("border-color", newval);
			$('.form-group__amount.focus-within').css("border-color", newval);
        }
	);
	...
	cf_wp_customize(
		'cf_single_camp_tabs_nav_fontsize', 
		function( newval ) {
			$('#campaignTab .nav-link').css("font-size", newval + 'px');
			$('#campaignTab .nav-link span').css("font-size", newval + 'px');
        }
	);
	...
	cf_wp_customize(
		'cf_single_camp_tabs_activity_tab_btn_fontsize', 
		function( newval ) {
			$('#crowdfundly-activites-load-more').css("font-size", newval + 'px');
        }
	);
	...
	cf_wp_customize( 
		'cf_single_camp_similar_camp_card_title_fontsize', 
		function( newval ) {
			$('.crowdfundly-single-camp .campaign-card__title').css('font-size', newval + 'px');
        }
	);
	...
	cf_wp_customize( 
		'cf_single_camp_similar_camp_card_description_fontsize', 
		function( newval ) {
			$('.crowdfundly-single-camp .campaign-card__description').css('font-size', newval + 'px');
        }
	);
	...
	cf_wp_customize( 
		'cf_single_camp_similar_camp_card_raised_amount_fontsize', 
		function( newval ) {
			$('.crowdfundly-single-camp .campaign-card__amount').css('font-size', newval + 'px');
			$('.crowdfundly-single-camp .campaign-card__amount strong').css('font-size', newval + 'px');
        }
	);
