...
/**
 * Elementor Organization Widget
 * 
 * @package     crowdfundly
 * @author      Keramot UL Islam <sourav926>
 * @since       1.0.0
 */
class OrganizationWidget extends Widget_Base
{
	...
	{
		$orgs_info = OrganizationController::get_organization_info();

        if ( $orgs_info && ! empty( $orgs_info ) ) {
	...
	{
		$social_profiles = $this->get_social_info();
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			...
			[
				'label' => __( 'Template One Background Color', 'crowdfundly' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#fff',
				'selectors' => [
					'{{WRAPPER}} .template__1 .organization__details' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .template__1 .organization__details'
			]
		);
		...
		$this->add_control(
			'org_social_media_background_color',
			[
				'label' => __( 'Template Two Background Color', 'crowdfundly' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#fff',
				'separator' => 'after',
				'selectors' => [
					'{{WRAPPER}} .template__2 .organization__details-left .organization__info' => 'background-color: {{VALUE}}',
				],
			]
		);
