...
/**
 * Customizer Switcher field Control
 * 
 * @package     crowdfundly
 * @author      Keramot UL Islam <sourav926>
 * @since       1.0.0
 */
class SwitcherControl extends \WP_Customize_Control
{
	...
	public function enqueue()
	{
		wp_enqueue_script( 'crowdfundly-customizer-switcher-control',
			cf_asset( 'customizer/js/switcher.js' ),
			array( 'jquery' ),
			CROWDFUNDLY_VERSION,
			true
		);
		wp_enqueue_style( 'crowdfundly-customizer-switcher-control-css', 
			cf_asset( 'customizer/css/switcher.css' ),
			array(),
			CROWDFUNDLY_VERSION
		);
