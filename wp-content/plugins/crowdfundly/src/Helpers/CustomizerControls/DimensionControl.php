...
class DimensionControl extends \WP_Customize_Control
{
	...
	public static function four_horse_men($wp_customize, $section, $ids)
	{
		...
		$wp_customize->add_control( new DimensionControl( $wp_customize, $ids[0],
			array(
		...
		$wp_customize->add_control( new DimensionControl( $wp_customize, $ids[1],
			array(
				'type'     => 'crowdfundly-dimension',
				'section'  => $section,
				'settings' => $ids[1],
		...
		$wp_customize->add_control( new DimensionControl( $wp_customize, $ids[2],
			array(
				'type'     => 'crowdfundly-dimension',
				'section'  => $section,
				'settings' => $ids[2],
		...
		$wp_customize->add_control( new DimensionControl( $wp_customize, $ids[3],
			array(
				'type'     => 'crowdfundly-dimension',
				'section'  => $section,
				'settings' => $ids[3],
