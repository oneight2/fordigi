...
function cf_customizer_style() {
	...
	<style type="text/css">
		...
		.campaign__actions-btn.donation-btn {
			background-color: <?php echo get_theme_mod( 'crowdfundly_single_camp_contribute_btn_bg_color', '' ); ?> !important;
			color: <?php echo get_theme_mod( 'crowdfundly_single_camp_contribute_btn_color', '' ); ?> !important;
			border-color: <?php echo get_theme_mod( 'crowdfundly_single_camp_contribute_btn_border_color', '' ); ?> !important;
		...
		.campaign__actions-btn.donation-btn:hover {
			background-color: <?php echo get_theme_mod( 'crowdfundly_single_camp_contribute_btn_hover_bg_color', '' ); ?> !important;
			color: <?php echo get_theme_mod( 'crowdfundly_single_camp_contribute_btn_hover_color', '' ); ?> !important;
			border-color: <?php echo get_theme_mod( 'crowdfundly_single_camp_contribute_btn_hover_border_color', '' ); ?> !important;
		}
		#share-campaign-btn,
		#set-reminder-btn {
