...
use Crowdfundly\App\Helpers\CustomizerControls\HeadingControl;
use Crowdfundly\App\Helpers\CustomizerControls\RangeControl;
use Crowdfundly\App\Helpers\CustomizerControls\SelectControl;
use Crowdfundly\App\Helpers\CustomizerControls\SwitcherControl;

function single_campaign($wp_customize) {
	$wp_customize->add_setting( 'cf_single_camp_heading', array(
		'sanitize_callback' => 'esc_html',
	) );
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_single_camp_heading', 
		array(
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_single_camp_detail_heading', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_single_camp_name_fontsize', 
		array(
	...
	$wp_customize->add_control( new SelectControl( $wp_customize, 'cf_single_camp_name_text_transform', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'crowdfundly_single_camp_org_name_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new SelectControl( $wp_customize, 'cf_single_campn_donation_btn_text_transform', 
		array(
			'type'     => 'crowdfundly-select',
			'section'  => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_single_campn_donation_btn_text_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_single_campaign_page',
	...
	$wp_customize->add_setting( 'cf_single_camp_popup_common', array(
		'sanitize_callback' => 'esc_html',
	) );
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_single_camp_popup_common', 
		array(
			'label'	            => __( 'Popups', 'crowdfundly' ),
			'settings'	        => 'cf_single_camp_popup_common',
			'section'  	        => 'cf_single_campaign_page',
			'priority'          => 2,
			'input_attrs' => array(
				'class' => 'crowdfundly-heading',
	...
	$wp_customize->add_setting( 'cf_single_camp_popup_donation', array(
		'sanitize_callback' => 'esc_html',
	) );
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_single_camp_popup_donation', 
		array(
			'label'	            => __( 'Donation Popup', 'crowdfundly' ),
			'settings'	        => 'cf_single_camp_popup_donation',
			'section'  	        => 'cf_single_campaign_page',
			'priority'          => 2,
			'input_attrs' => array(
				'class' => 'crowdfundly-heading',
	...
	$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cf_single_camp_donation_popup_active_btn_bg_color', 
		array(
			'label'      => __( 'Popup Contribute Button Background Color', 'crowdfundly' ),
			'section'    => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cf_single_camp_donation_popup_active_btn_color', 
		array(
			'label'      => __( 'Popup Contribute Button Color', 'crowdfundly' ),
			'section'    => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new \WP_Customize_Color_Control( $wp_customize, 'cf_single_camp_donation_popup_active_btn_border_color', 
		array(
			'label'      => __( 'Popup Contribute Button Border Color', 'crowdfundly' ),
			'section'    => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_single_camp_donation_popup_active_btn_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_single_campaign_page',
			'settings'          => 'cf_single_camp_donation_popup_active_btn_fontsize',
			'label'             => __( 'Popup Contribute Button Font Size', 'crowdfundly' ),
			'input_attrs'       => array(
				'min'    => 5,
				'max'    => 30,
				'step'   => 1,
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_single_camp_tabs', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_single_camp_tabs_nav_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_single_camp_tabs_activity_tab_btn_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_single_camp_similar_campaign', 
		array(
	...
	$wp_customize->add_control(new SwitcherControl( $wp_customize, 'cf_single_camp_hide_similar_camps', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_single_camp_heading_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new SelectControl( $wp_customize, 'cf_similar_camp_heading_text_transform', 
		array(
			'type'     => 'crowdfundly-select',
			'section'  => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_single_camp_card', 
		array(
	...
	$wp_customize->add_control( new SelectControl( $wp_customize, 'cf_single_camp_card_column', 
		array(
			'type'     => 'crowdfundly-select',
			'section'  => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_single_camp_similar_camp_card_title_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_single_camp_similar_camp_card_description_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_single_campaign_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_single_camp_similar_camp_card_raised_amount_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_single_campaign_page',
