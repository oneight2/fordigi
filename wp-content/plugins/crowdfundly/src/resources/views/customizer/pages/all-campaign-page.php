...
use Crowdfundly\App\Helpers\CustomizerControls\NumberControl;
...
function all_campaign($wp_customize) {
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_all_campaign_heading', 
		array(
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_all_campaign_search_bar', 
		array(
	...
	$wp_customize->add_control(new SwitcherControl( $wp_customize, 'cf_all_camp_hide_search_bar', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_all_camp_title_font_size', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'crowdfundly_all_camp_search_btn_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_all_campaign_page',
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_all_campaign_card', 
		array(
	...
	$wp_customize->add_control( new NumberControl(
	...
	$wp_customize->add_control( new SelectControl( $wp_customize, 'cf_all_camp_card_column', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_all_camp_image_width', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_all_campaign_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'crowdfundly_all_camp_name_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_all_campaign_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'crowdfundly_all_camp_description_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_all_campaign_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'crowdfundly_all_camp_target_raised_amount_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_all_campaign_page',
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_all_campaign_load_more', 
		array(
	...
	$wp_customize->add_control( new SwitcherControl( $wp_customize, 'cf_all_campaign_load_more_hide', 
		array(
			'label' => esc_html__('Hide Section', 'crowdfundly'),
			'section' => 'cf_all_campaign_page',
