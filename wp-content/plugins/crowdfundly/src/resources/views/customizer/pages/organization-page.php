...
use Crowdfundly\App\Helpers\CustomizerControls\DimensionControl;
...
function organization_page($wp_customize) {
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'crowdfundly_org_common', 
		array(
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_org_slider', 
		array(
	...
	$wp_customize->add_control(new SwitcherControl( $wp_customize, 'cf_org_hide_slider', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_org_slider_height', 
		array(
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'crowdfundly_org_detail', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_org_logo_width', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_organization_name_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_org_social_media_icon_size', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_organization_title_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new SelectControl( $wp_customize, 'cf_organization_title_text_transform', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_organization_description_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_org_recent_campaign', 
		array(
	...
	$wp_customize->add_control(new SwitcherControl( $wp_customize, 'cf_org_hide_recent_camps', 
		array(
			'label' => esc_html__('Hide Section', 'crowdfundly'),
			'section' => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_org_heading_font_size', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new SelectControl( $wp_customize, 'cf_org_recent_camp_heading_text_transform', 
		array(
			'type'     => 'crowdfundly-select',
			'section'  => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_org_recent_camp_card', 
		array(
	...
	$wp_customize->add_control( new SelectControl( $wp_customize, 'cf_org_recent_camp_card_column', 
		array(
			'type'     => 'crowdfundly-select',
			'section'  => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'crowdfundly_org_card_name_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'crowdfundly_org_card_description_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'crowdfundly_org_card_raised_amount_fontsize', 
		array(
			'type'              => 'crowdfundly-range-value',
			'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_org_all_camp_btn', 
		array(
	...
	$wp_customize->add_control(new SwitcherControl( $wp_customize, 'cf_org_hide_btn', 
		array(
	...
	$wp_customize->add_control( new RangeControl( $wp_customize, 'cf_org_camp_button_padding', 
		array(
			'type'              => 'crowdfundly-range-value',
            'section'           => 'cf_organizaton_page',
	...
	$wp_customize->add_control( new HeadingControl( $wp_customize, 'cf_org_all_camp_btn_border_radius_heading', 
		array(
	...
	DimensionControl::four_horse_men($wp_customize, 'cf_organizaton_page', $ids);
